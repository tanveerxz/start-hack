    ...
    return (
      <DashboardShell>
        <div className="grid gap-4 md:gap-5 xl:gap-6">
          <div className="h-16 rounded-[22px] border border-white/10 bg-white/[0.03] animate-pulse" />
          <div className="h-64 rounded-[30px] border border-white/10 bg-white/[0.03] animate-pulse" />
          <div className="grid gap-4 md:grid-cols-2 2xl:grid-cols-4">
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="h-40 rounded-[22px] border border-white/10 bg-white/[0.03] animate-pulse"
              />
            ))}
          </div>
          <div className="grid gap-4 2xl:grid-cols-[1.35fr_0.9fr]">
            <div className="h-[28rem] rounded-[26px] border border-white/10 bg-white/[0.03] animate-pulse" />
            <div className="h-[28rem] rounded-[26px] border border-white/10 bg-white/[0.03] animate-pulse" />
          </div>
        </div>
      </DashboardShell>
